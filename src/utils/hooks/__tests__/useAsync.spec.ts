...
describe('useAsync', () => {
  ...
  describe('a success', () => {
    let hook: {
      result: {current: {loading: any; value: any; error: any}};
      waitForNextUpdate: () => any;
      rerender: (arg0: {fn: () => Promise<unknown>}) => void;
    };
    let callCount = 0;
  ...
  describe('an error', () => {
    let hook: {
      result: {current: {loading: any; error: any; value: any}};
      waitForNextUpdate: () => any;
      rerender: (arg0: {fn: () => Promise<unknown>}) => void;
    };
    let callCount = 0;
  ...
  describe('re-evaluates when dependencies change', () => {
    describe('the fn is a dependency', () => {
      let hook: {
        waitForNextUpdate: () => Promise<any[]>;
        result: {current: {value: any}};
        rerender: (arg0: {fn: () => Promise<string>}) => void;
      };
      let callCount = 0;
